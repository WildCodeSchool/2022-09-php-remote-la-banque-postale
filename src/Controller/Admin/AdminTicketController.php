...
{
    #[Route('/', name: 'admin_app_ticket_index', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'admin_app_ticket_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'admin_app_ticket_delete', methods: ['POST'])]
