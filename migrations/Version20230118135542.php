 ...
 */
final class Version20230118135542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A2073AED2B36786B ON tutoriel (title)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A2073AED2B36786B ON tutoriel');
    }
}
